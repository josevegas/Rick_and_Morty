...
export default function About(){
    return(
        <div className={style.divAbout}>
            ...
            <img src="https://scontent.fpiu1-1.fna.fbcdn.net/v/t1.6435-9/198863587_10159341059361740_2353617559994962899_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=174925&_nc_eui2=AeGtJaP0ujW8q7eFmEGikvpmqSRJb4p2BV-pJElvinYFXzBym1oZuInGf0HQcTV9beM&_nc_ohc=4Z9dDbyLJuQAX86wkew&_nc_oc=AQkerrjgzYrkuTFNq7KOpntndh7Zz5J2AaTHiGswsZ0Ctw1CUDFRf_Dvkd3M13T789WWCtm2jZJ4mI-xPPYqChPW&_nc_ht=scontent.fpiu1-1.fna&oh=00_AfBq3vc7R29jW2iReuKKQEjpKkCLF55nVLnrJtpHVV3sww&oe=64371CA8" alt="Foto de José Vegas" />
        </div>
    )
}